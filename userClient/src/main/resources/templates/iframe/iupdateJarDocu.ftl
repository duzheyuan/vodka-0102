...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <form role="form" method="post" action="/JarCrud/jarUpdate" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="jarName">jar包名</label><input type="text" name="jarName"  value="${jarNew.jarName}" class="form-control"
                                                             id="jarName" readonly="readonly"/>
                </div>
                <div class="form-group">
                    <label for="uname">上传人</label><input type="text" value="${jarNew.uname}" name="uname" class="form-control"
                                                         readonly="readonly"
                                                         id="uname"/>
...
<script>
    ...
    var um = UM.getEditor('myEditor', {
        ...
        imagePath: 'http://localhost:8080/fileUploadPath/image/',
